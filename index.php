...
<body>
    <header>
        <h1 class="logo">INSAT <span class="logoCP">CP</span></h1>
        <nav>
    ...
    <section class="main">
        <div class="slide">
            <h1>INSAT's competitive programming platform</h1>
            <h3>Platform for organizing contests and training</h3>
    ...
    <div class="container-fluid container-lg p-5" id="links">
        <div class="row">
            ...
            <div class="col-sm-6 col-md-3 mt-2 ">
                <a href="#">
                    <div class="card h-100">
                        <img src="assets/images/ballons.png" class="card-images-top" alt="...">
                        <div class="card-body">
            ...
            <div class="col-sm-6 col-md-3  mt-2 ">
                <a href="#">
                    <div class="card h-100">
                        <img src="assets/images/How-to-Learn-Programming.png" class="card-images-top" alt="...">
                        <div class="card-body">
            ...
            <div class="col-sm-6 col-md-3 mt-2">
                <a href="#">
                    <div class="card h-100">
                        <img src="assets/images/tools.png" class="card-images-top" alt="...">
                        <div class="card-body">
