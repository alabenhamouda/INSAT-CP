 ...
 */
final class Version20210614075914 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contest (id INT NOT NULL, creator_id INT NOT NULL, title VARCHAR(255) NOT NULL, duration INT NOT NULL, is_published BOOLEAN NOT NULL, start_date TIMESTAMP(0) WITH TIME ZONE NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE submission (id INT NOT NULL, problem_id INT NOT NULL, user_id INT NOT NULL, status_id INT NOT NULL, code TEXT NOT NULL, language VARCHAR(255) NOT NULL, token VARCHAR(255) DEFAULT NULL, in_contest BOOLEAN NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
